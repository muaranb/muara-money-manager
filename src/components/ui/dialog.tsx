...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 opacity-70 text-slate-400 hover:text-white hover:bg-white/10 transition-opacity focus:outline-none focus:ring-2 focus:ring-emerald-400/50">
        <X className="h-4 w-4" />
